...
esbeltez moderada a alta. El factor de forma $(1+k)$ (un coeficiente que mide
...
sin embargo, esta hipótesis descansa sobre una base empírica (modelos geométricamente semejantes de buques con $L/B$ típicamente superiores a~7) que excluye por completo a los cascos de baja esbeltez propios de la pesca de altura argentina, donde la
...
procedimientos estándar de la ITTC (International Towing Tank Conference),
calibrados sobre geometrías de
referencia mercantes y esbeltas, conduce a una subestimación sistemática de la
...
\begin{itemize}
    ...
    \item Evaluar sobre una hélice de diseño convencional cedida por un proveedor privado el comportamiento en condiciones clásicas
...
hélice de referencia Wageningen B4-60 y, sobre el propulsor de paso variable
P206, el estudio de los efectos del régimen de transición laminar--turbulenta
