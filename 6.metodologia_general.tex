...
\begin{figure}[htpb]
    ...
    \caption{Esquema del montaje del ensayo de resistencia: el modelo del casco se vincula al carro dinamométrico a través del poste de arrastre y la celda de carga, quedando libre en cabeceo y hundimiento mientras el carro impone la velocidad de avance. Adaptado de \citet{birk2019}.}
...
Las características hidrodinámicas de una hélice en flujo uniforme se obtienen mediante el \textbf{ensayo de aguas abiertas} (\emph{open-water test}), la contraparte para el propulsor del ensayo de resistencia del casco. A diferencia de este último, la hélice se ensaya \emph{aislada}, sin casco delante, de modo que el flujo que la alcanza es uniforme y libre de la estela del buque.
...
\begin{figure}[htpb]
    ...
    \caption{Esquema del ensayo de aguas abiertas: la hélice, montada sobre el eje portahélice accionado por el dinamómetro de aguas abiertas, opera en flujo uniforme sin casco mientras el carro impone la velocidad de avance $V_a$ y se mide el empuje $T$ y el par $Q$. Adaptado de \citet{birk2019}.}
