...
\begin{figure}[htpb]
    ...
    \caption{Esquema del montaje del ensayo de resistencia: el modelo del casco se vincula al carro dinamométrico a través del poste de arrastre y la celda de carga, quedando libre en cabeceo y hundimiento mientras el carro impone la velocidad de avance. Adaptado de \citet{birk}.}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.75\textwidth]{images/esquema_aguas_abiertas.png}
    \caption{Esquema del ensayo de aguas abiertas: la hélice, montada sobre el eje portahélice accionado por el dinamómetro de aguas abiertas, opera en flujo uniforme sin casco mientras el carro impone la velocidad de avance $V_a$ y se mide el empuje $T$ y el par $Q$. Adaptado de \citet{birk}.}
