...
El segundo pesquero analizado, de ahora en más P3, fue diseñado y construido por el astillero JPA S.A. El modelo fue construido a escala $\lambda = 13$ y ensayado en una sola condición de calado. La Tabla~\ref{tab:main_param_p3} resume sus características principales.
...
prestaciones. Recordando las definiciones adimensionales introducidas en el
...
\end{equation}
%
el procedimiento estándar recomendado por la ITTC para su escalado es el método
...
$\Delta K_Q > 0$; el empuje corregido \emph{aumenta} y el par \emph{disminuye} al pasar
