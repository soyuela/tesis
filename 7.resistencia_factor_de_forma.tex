...
Asimismo aunque esta sección se centra inicialmente en el modelo objetivo (\textit{P1}), el análisis experimental incluye también una campaña independiente con el modelo del portacontenedores KCS. La incorporación de este buque de referencia obedece al interés de complementar el análisis mediante la inclusión de una geometría radicalmente distinta a los pesqueros: una esbeltez mucho mayor ($L/B \approx 7.1$ vs. 2.8–3.5), una popa afinada con transición suave al codaste en contraste con la popa robusta de los pesqueros, y la ausencia de dormido significativo frente al dormido pronunciado de los buques pesqueros. Esta comparación permite examinar cómo la hidrodinámica del factor de forma varía cuando se introducen cambios fundamentales en las proporciones globales y la configuración local del casco.
...
del KCS. Como cada punto del diagrama corresponde al promedio de varias
...
\caption{Ajuste lineal con ponderación mediante el método de York aplicado al \textit{KCS} para la estimación de $(1+k)$ y su incertidumbre.}
\label{fig:york_kcs}
\end{figure}
...
menos numerosos en el rango de ajuste, en el KCS se alinean estrechamente sobre ella,
lo que se traduce en una determinación mucho más precisa de $(1+k)$. Esta
comparación cuantitativa respalda la observación cualitativa de que el KCS
...
\begin{figure}[h]
    ...
    doble cuerpo en función de $Fr$ (puntos azules) para el \textit{P1}, 
    Calado~1.}
...
frente a $Re$ obtenidos mediante CFD ``double body'' (DB) para el KCS 
...
observado en el KCS. Al comparar el valor de $(1+k)$ resultante con 
...
del \textit{P2}, el \textit{P3} y el KCS, comparando en cada caso el 
...
\begin{figure}[htpb]
    ...
    \textit{P2}, el \textit{P3} y el KCS, comparadas con el valor CFD DB a 
...
$19\%$ al $42\%$ según la fórmula y el casco considerados. En cambio, para el KCS ($L/B=7{.}14$), un casco de 
