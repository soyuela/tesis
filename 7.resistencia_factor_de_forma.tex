...
modelo (1:20) y escala buque (1:1), a $F_n=0.2$, vistas desde la proa, la 
...
modelo ($R_n=1.3\times10^6$) y el de escala buque ($R_n=1.1\times10^8$) es del 
...
en la configuración Ctrl+Z, lo que indica que el bulbo no es su causa: la 
desviación respecto de la recta teórica es una característica propia del 
resto del casco.
