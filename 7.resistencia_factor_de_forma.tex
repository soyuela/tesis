...
adoptado fue $(1+k) = 1.053$, correspondiente al rango $0.13 < Fr < 0.20$.
...
del KCS. En este caso, la incertidumbre de la coordenada vertical se estimó
directamente a partir de la dispersión de las repeticiones disponibles en
cada velocidad, que fue del orden del $1$ al $5\%$ de la resistencia medida,
propagándola luego a $C_{TM}/C_{F0}$. El ajuste ponderado confirma el valor
adoptado y le asocia una incertidumbre expandida de $\pm 0.019$, esto es, una
incertidumbre relativa de apenas el $\pm 1.8\%$, como se muestra en la
Figura~\ref{fig:york_kcs}.
...
incertidumbre relativa de cada punto individual ($\sim 3\%$). Esta reducción
