...
en $F_n = 0.20$. La línea roja indica el valor de $(1+k)$ adoptado 
mediante el método de Prohaska en el rango $0.15 < F_n < 0.20$. 
...
$C_{TM}/C_{F0}$ frente a $F_n^4/C_{F0}$, donde $C_{F0}$ es el 
coeficiente de fricción de placa plana al $Rn$ del modelo según 
...
restringir severamente el rango de $F_n$ analizado, o incluso a descartar el 
...
proa no responde a la ley $F_n^4$ supuesta por el método.
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=.9\columnwidth]{images/prohaska-bulbo-ctrlz-165.png}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=.9\columnwidth]{images/prohaska-bulbo-ctrlz-195.png}
	\caption{Diagrama de Prohaska comparando modelos con y sin bulbo 
	($T = 0{,}195$~m).}
...
$F_n \approx 0{,}25$, coincidiendo con la velocidad de diseño del bulbo. Por 
...
excepción del punto $F_n \approx 0{,}24$, inmediatamente anterior al cruce, 
...
\begin{figure}[htpb]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Ct-consinbulbo-165.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Cw-consinbulbo-165.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Cv-consinbulbo-165.png}
...
reduce $C_W$ en el entorno de $F_n \approx 0{,}20$--$0{,}30$, pero pierde 
ese beneficio por encima de $F_n \approx 0{,}35$, donde la tendencia se 
...
\begin{figure}[htpb]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Ct-consinbulbo-195.png}
        \caption{Resistencia total.}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Cw-consinbulbo-195.png}
        \caption{Resistencia por olas.}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Cv-consinbulbo-195.png}
...
ambas configuraciones de proa, junto con el rango de $F_n$ empleado en cada 
regresión.}
\label{tab:k_bulbo_ctrlz}
\begin{tabular}{llcc}
\hline
Calado & Configuración & Rango de $F_n$ & $(1+k)$ \\
\hline
...
\begin{figure}[htpb]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/k-consinbulbo-165.png}
        \caption{$T = 0{,}165$~m.}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/k-consinbulbo-195.png}
        \caption{$T = 0{,}195$~m.}
...
favorable para la resistencia total por encima de $F_n \approx 0{,}25$, 
