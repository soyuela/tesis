...
``laminarización'' parcial del flujo a bajas velocidades, como se describe 
...
La Figura~\ref{fig:york_tpa} ilustra el ajuste ponderado obtenido para el
Calado~1, y la Tabla~\ref{tab:york_tpa} reúne los valores de $(1+k)$ y su
incertidumbre expandida para los tres calados. Los factores de forma
...
puntos experimentales se apartan de la recta teórica, y son además mucho
...
$C_{TM}/C_{F0}$ vs $Fr^4/C_{F0}$ se aproxima mejor a la linealidad teórica)
...
reportados en \citet{TERZIEV2021147}. La concordancia no es excelente: ambas 
...
geosims utilizadas en \citet{gomezgarcia} para calibrar su correlación corresponden a cascos esbeltos convencionales, con relaciones $L_{PP}/B$ comprendidas entre $6{.}98$ y $9{.}07$. Ninguna se aproxima siquiera a la baja esbeltez del \textit{P1} ($L/B \approx 2{.}8$--$3{.}5$). La correlación se aplica, por lo tanto, fuera del dominio para el que fue derivada, en un régimen donde la resistencia por presión viscosa, despreciable en los cascos esbeltos de lamuestra original, pasa a ser una fracción dominante de la resistencia viscosa total, como se demuestra en la
