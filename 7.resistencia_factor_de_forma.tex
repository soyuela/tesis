...
\caption{Ajuste lineal con ponderación mediante el método de York aplicado al \textit{P1} para la estimación de $(1+k)$ y su incertidumbre. Calado~1.}
\label{fig:york_tpa}
\end{figure}
...
$(1+k) = 1.059 \pm 0.017$, esto es, una incertidumbre relativa de apenas el
$\pm 1.6\%$.
