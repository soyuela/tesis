...
propagándola luego a $C_{TM}/C_{F0}$. El ajuste ponderado arroja
$(1+k) = 1.053 \pm 0.017$, esto es, una incertidumbre relativa de apenas el
$\pm 1.6\%$ como se muestra en la Figura \ref{fig:york_kcs}.
...
puntos experimentales se apartan de la recta teórica ---elevando la
incertidumbre del ajuste---, en el KCS se alinean estrechamente sobre ella,
