...
líneas punteadas verticales indican los límites del rango de Froude recomendado por la ITTC para la aplicación 
del método de Prohaska ($Fr = 0{.}10$ y $Fr = 0{.}20$), correspondientes al 
modelo \textit{KCS} a escala 1:79 ensayado en el LabHiNO, mientras que la línea 
...
``transom form factor'' $k_{tr}>0$ \citep{korkmaz_wetted_transom}. Su
...
propia del resto del casco. La anomalía reportada en 
