...
El Capítulo~\ref{chap:antecedentes} presentó las limitaciones conocidas del procedimiento ITTC-78 para hélices: la hipótesis de que el efecto de escala es puramente friccional (Sección~\ref{sec:ittc78_propulsor}), la evidencia de una componente de presión no despreciable (Sección~\ref{sec:presion_escala}) y la posible presencia de un régimen de transición laminar-turbulenta a escala de modelo, con el consiguiente comportamiento no monótono de $K_T$ y $K_Q$ conocido como ``chichón'' (Sección~\ref{sec:chichon_antec}). Este capítulo cuantifica ambos mecanismos --distintos entre sí y que operan sobre saltos de Reynolds diferentes-- para dos hélices de referencia, combinando datos experimentales propios (campaña del LabHiNO) y de terceros con simulaciones CFD RANS.
...
\end{figure}
>>>>>>> bf4ff4fd3cfbf25e8b7bd24d95dc39afad4efe91
...
Cuantitativamente, la amplitud del chichón experimental --medida como la diferencia
...
=======
descomposición, pero sí acotarse mediante un argumento de magnitud. La contribución
friccional al empuje según la descomposición completamente turbulenta es pequeña,
$|K_{Tf}| \approx 0.0018$--$0.0022$, del orden del $1\%$ de $K_T$, mientras que el
SST-LM predice valores de $K_T$ entre un $4.8$ y un $6.7\%$ por encima del
completamente turbulento a $Re_c = 0.36\times10^6$. Aun para un álabe completamente
libre de fricción, ésta podría explicar a lo sumo entre el $19$ y el $43\%$ de ese
desfasaje: la mayor parte es, necesariamente, de origen de presión. El par lo
>>>>>>> bf4ff4fd3cfbf25e8b7bd24d95dc39afad4efe91
...
% \begin{figure}[h!]
%     \centering
%     \includegraphics[width=0.5\textwidth]{figuras/coreana_cf_panel.png}
%     \caption{Distribución espacial de $C_f$ sobre el dorso del álabe, para $J=0.5$,
%     dos valores de $Re_c$ (fila superior: bajo; inferior: alto) y los cuatro niveles
%     de turbulencia. Las flechas indican la dirección local de la tensión de corte.}
...
=======
En síntesis, la transición deja una firma \emph{local} clara en el campo de fricción
>>>>>>> bf4ff4fd3cfbf25e8b7bd24d95dc39afad4efe91
...
gradualmente al chichón experimental sin reproducir su forma, en StarCCM+ las mismas
...
=======
La Tabla~\ref{tab:mae_global_coreana} resume el error absoluto
...
Sin embargo, la B4-60 ($A_E/A_0=0.60$, sin escora) es geométricamente muy distinta del
...
escora de punta comparable ($25.7°$ frente a $16.8°$). Para el P1727, la descomposición directa de las fuerzas en sus componentes de
...
=======
turbulentas, sin transición), la fracción $f_p=\Delta K_{Tp}/\Delta K_T$ resulta
>>>>>>> bf4ff4fd3cfbf25e8b7bd24d95dc39afad4efe91
...
geométricamente más parecida al P206 en $A_E/A_0$, $c/D_{0.7R}$ y presencia de escora--
...
en parte a compensaciones ajenas al $A_E/A_0$ --diferencias de escora, de $Re$ de
...
Sección~\ref{sec:coreana_resultados} muestra amplitudes de chichón de hasta el $16\%$ en
...
trabajo-- cuyos propulsores operan precisamente en el rango de $Re_c$ donde el chichón es más
pronunciado, esto sugiere que la caracterización del régimen transicional no es un
