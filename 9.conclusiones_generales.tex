...
de Froude y el de Reynolds del buque, ya que fijar $Fr$ para reproducir la
generación de olas obliga a operar a un $Re$ mucho menor. En la propulsión, la
...
de las herramientas de ese edificio; su insuficiencia, cuando aparece, es un
...
que comparte con el ensayo a escala geométrica grande: la ausencia de datos
...
El primer eje aborda un tipo de buque escasamente estudiado en la literatura de
...
No fue posible reproducir los valores experimentales de $K_T$ y $K_Q$ en el régimen
transicional con ningún valor de intensidad turbulenta ni con ninguno de los dos
solvers empleados. No obstante, en las simulaciones el desplazamiento de la curva
completamente turbulenta hacia los valores experimentales aparece asociado a cambios
en la distribución de presión: la componente friccional es demasiado pequeña para
explicar la brecha, y el par incluso aumenta con el modelo de transición, cuando la
fricción por sí sola solo podría reducirlo. Esto inclina a suponer que el mecanismo
que traslada la curva es predominantemente de presión, aunque la evidencia
disponible no permite afirmarlo de manera concluyente. Al propagar esta física a
...
\textit{P206} se estimó por dos vías independientes que convergen al mismo valor,
$f_p \approx 0{.}90$--$0{.}92$. La primera calibra $f_p$ como el valor que anula el
error de la extrapolación completamente turbulenta frente a una simulación de
referencia resuelta directamente a escala grande. La segunda lo mide de forma
directa, como el cociente $\Delta K_{Tp}/\Delta K_T$ obtenido al descomponer las
fuerzas sobre la pala en sus componentes de presión y fricción entre la condición de
modelo y la de escala grande, ambas completamente turbulentas. El valor resulta
mayor que el de la B4-60 ($0{.}70$--$0{.}77$); establecer si esa diferencia responde
a la geometría de la pala requiere el mapeo sistemático que se plantea como trabajo
futuro.
...
fenómeno y omite la mayor. Haber cuantificado esa componente de presión, en
particular en los cascos de baja esbeltez hasta ahora poco estudiados, constituye la
...
a escala geométrica grande, carece de un dato experimental con el cual contrastarse a
esa escala; el ensayo físico, a su vez, solo accede al régimen de modelo. La
validación cruzada entre ambos, en el régimen donde el ensayo es posible, es lo que
otorga confianza a la extrapolación numérica más allá de él.
...
\begin{itemize}
    ...
    efecto de escala completamente turbulento sobre el empuje ($\sim 76$--$77\%$), y se
    caracterizó experimental y numéricamente la joroba transicional del propulsor
    \textit{P206}, estimando su fracción de presión en $f_p \approx 0{.}90$--$0{.}92$
...
\begin{itemize}
    ...
    buques reales, dada la magnitud de las discrepancias frente a los métodos estándar.
    ...
    confirmarse, esta vía volvería más predecible el ensayo de túnel y su extrapolación,
...
joroba transicional, abriendo un campo todavía ancho, donde el mapeo del
